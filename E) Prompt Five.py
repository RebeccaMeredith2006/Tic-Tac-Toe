...
def button_click(row, col):
    ...
    if board[row][col] == "":
        ...
        if game_mode == "Multiplayer":
            ...
            current_player = "O"
            root.after(200, ai_move)  # Delay AI move by 500 ms
